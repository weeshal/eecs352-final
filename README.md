...
We quickly pivoted and tried to do many different things to try and get better results. STFT, chromagram info, pattern matching with cross-correlation instead of cosine.
